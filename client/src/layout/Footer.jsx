      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <Link
              to="/"
              aria-label="Europetourz home"
              className="inline-flex items-center transition hover:opacity-90"
            >
              <img
                src="/europe-tourz-logo.png"
                alt="Europetourz - Premium Europe Tours"
            ...
            <div className="mt-5 space-y-3">
              ...
              <address className="not-italic leading-7 text-gray-400">
                Dunajská 4516/66
                <br />
        ...
        <div className="mt-12 border-t border-white/10 pt-7">
          <div className="flex flex-col gap-4 text-sm text-gray-500 md:flex-row md:items-center md:justify-between">
            <p>© {currentYear} Europetourz. All rights reserved.</p>
